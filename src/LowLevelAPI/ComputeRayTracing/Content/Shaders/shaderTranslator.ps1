...
..\..\..\..\..\Binaries\SPIRV-Cross.exe --version 310 VK\ComputeShader.spirv --output GLSL\ComputeShader.glsl
...
..\..\..\..\..\Binaries\SPIRV-Cross.exe --es --version 310 VK\ComputeShader.spirv --output ESSL\ComputeShader.essl
