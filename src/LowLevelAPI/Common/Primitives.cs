    ...
    public static class Primitives
    {
        public static void Sphere(float diameter, int tessellation, out List<VertexPositionNormalTangentTexture> vertexData, out List<ushort> indexData, bool uvHorizontalFlip = false, bool uvVerticalFlip = false)
        {
            ...
            for (int i = 0; i < horizontalSegments; i++)
            {
                ...
                vertexData.Add(new VertexPositionNormalTangentTexture(Vector3.Down * radius, Vector3.Down, Vector3.Zero, new Vector2(u, v)));
            }
            ...
            for (int i = 0; i < horizontalSegments; i++)
            {
                ...
                vertexData.Add(new VertexPositionNormalTangentTexture(Vector3.Up * radius, Vector3.Up, Vector3.Zero, new Vector2(u, v)));
            }
        ...
        public static void Capsule(float height, float radius, int tessellation, out List<VertexPositionNormalTangentTexture> vertexData, out List<ushort> indexData)
        {
            ...
            vertexData.Add(new VertexPositionNormalTangentTexture((Vector3.Down * radius) + (Vector3.Down * 0.5f * height), Vector3.Down, Vector3.Zero, new Vector2(0.5f, 0.5f)));
            ...
            for (int i = 0; i <= tessellation; i++)
            {
                ...
                vertexData.Add(new VertexPositionNormalTangentTexture((normal * radius) + (Vector3.Up * cylinderHeight), normal, Vector3.Zero, new Vector2(1 - percent, 0)));

                // this.AddVertex((normal * radius) + (Vector3.Down * cylinderHeight), normal, new Vector2(1 - percent, 1));
                vertexData.Add(new VertexPositionNormalTangentTexture((normal * radius) + (Vector3.Down * cylinderHeight), normal, Vector3.Zero, new Vector2(1 - percent, 1)));
            ...
            vertexData.Add(new VertexPositionNormalTangentTexture((Vector3.Up * radius) + (Vector3.Up * 0.5f * height), Vector3.Up, Vector3.Zero, new Vector2(0.5f, 0.5f)));
        ...
        public static void Plane(float size, out List<VertexPositionNormalTangentTexture> vertexData, out List<ushort> indexData)
        {
            ...
            Matrix4x4 matrix;
            Matrix4x4.CreateLookAt(ref position, ref normal, ref up, out matrix);
