...
namespace Evergine.Assets.Extensions.DDS
{
    ...
    internal struct PixelFormat
    {
        ...
        /// <summary>
        /// Values that indicate the type of data contained in the surface.
        /// </summary>
        ...
        /// A FourCC of DX10 indicates the presence of the DDS_HEADER_DXT10 extended header,
        ...
        /// Valid when Flags include Rgb, Luminance, or Yuv.
        /// </summary>
        ...
        /// For instance, given the A8R8G8B8 format, the blue mask is 0x000000ff.
        /// </summary>
