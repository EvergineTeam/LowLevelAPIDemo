...
namespace Evergine.Assets.Extensions.DDS
{
    ...
    {
        /// <summary>
        /// The texture contains alpha data;
        ...
        /// (RGBBitCount contains the alpha channel bit count; ABitMask contains valid data)
        /// </summary>
        Alpha = 0x2,

        /// <summary>
        /// Texture contains compressed RGB data; the FourCC contains valid data.
        /// </summary>
        FourCC = 0x4,
