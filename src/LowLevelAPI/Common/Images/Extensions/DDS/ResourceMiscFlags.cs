...
namespace Evergine.Assets.Extensions.DDS
{
    ...
    internal enum ResourceMiscFlags : uint
    {
        ...
        /// The resource must be created with bind flags that specify it is both a render target and a shader resource.
        /// </summary>
        GenerateMips = 0x1,
        ...
        /// <summary>
        /// Enables an application to create a cube texture from a Texture2DArray containing six textures.
        /// </summary>
        TextureCube = 0x4,

        /// <summary>
        /// <para>Enables the resource created to be synchronized using the IDXGIKeyedMutex::AcquireSync and ReleaseSync APIs.
        /// The following resource creation D3D10 APIs, all of which take a D3D10_RESOURCE_MISC_FLAG parameter, have been extended to support the new flag.</para>
        /// <list type="">
        ...
        /// is required to call IDXGIKeyedMutex::AcquireSync before issuing any rendering commands to the surface,
        ...
        /// Setting this flag allows rendering on the surface via IDXGISurface1::GetDC.
        /// </summary>
        GdiCompatible = 0x20,
    }
}
