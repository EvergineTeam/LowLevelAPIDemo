..\..\..\..\..\Binaries\dxc.exe -Zpr -fvk-u-shift 20 all -fvk-s-shift 40 all -fvk-t-shift 60 all -spirv HLSL\ComputeFaces.fx -T cs_5_0 -E CS -Fo VK\ComputeFaces.spirv
...
..\..\..\..\..\Binaries\SPIRV-Cross.exe --msl VK\ComputeFaces.spirv --output MSL\ComputeFaces.msl
...
..\..\..\..\..\Binaries\SPIRV-Cross.exe --version 310 VK\ComputeFaces.spirv --output GLSL\ComputeFaces.glsl
...
cp .\VK\ComputeFaces.spirv .\VK\ComputeFaces.spv
cp .\VK\VertexShader.spirv .\VK\VertexShader.spv
cp .\VK\FragmentShader.spirv .\VK\FragmentShader.spv

..\..\..\..\..\Binaries\naga.exe --keep-coordinate-space VK\ComputeFaces.spv WGSL\ComputeFaces.wgsl
